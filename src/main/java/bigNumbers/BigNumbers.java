...
public class BigNumbers {
    public static void main(String[] args) {
        BigInteger bigInteger1 = new BigInteger("55555555555555555555555");
        BigInteger bigInteger2 = new BigInteger("22222222222222222222222");
        ...
        BigDecimal bigDecimal = new BigDecimal("222.2222222");
        System.out.println(bigDecimal.add(new BigDecimal(11.11111)));
